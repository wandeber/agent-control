...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      "List flow configs from Agent Control's bundled and user flow catalogs. Bundled flows come from the repository flows directory; user flows default to ~/.agent-control/flows.",
    inputSchema: objectSchema({
  ...
  },
  {
    ...
    description:
      "Resolve one flow from Agent Control's default catalog by flow id or directory name and return its config path plus loaded config.",
  ...
  },
  {
    ...
    description:
      "Block until a subscription's matching event exists, refreshing the source agent when possible. Use for explicit manual/debug waits or short opt-in foreground waits. Normal long-running orchestrators should use detached watchers/subscriptions.",
    inputSchema: objectSchema(
      {
