...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Dispatch the active flow step to its configured backend worker, optionally subscribe an orchestrator to terminal events, and return immediately. This is the normal non-polling coordinator operation.",
    inputSchema: objectSchema(
      {
