...
export function conversationWaitContract(runId: string, observerAgentId: string, cursor: string) {
  return {
    turn_policy: "keep_open_while_work_pending" as const,
    tool: "run_wait" as const,
    arguments: { run_id: runId, observer_agent_id: observerAgentId, cursor, timeout_ms: 3_600_000 },
