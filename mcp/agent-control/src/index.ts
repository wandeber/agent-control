...
const REUSE_CONSOLE_TOOL = {
  ...
  description:
    "Reuse and update the already-open Agent Control panel without opening another tab. Optionally pin run_id; use this after the first open_agent_control_console call.",
  inputSchema: {
    type: "object",
    properties: {
