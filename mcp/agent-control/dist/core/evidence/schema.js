...
function inlineSchemaReferences(value) {
    if (Array.isArray(value))
        return value.map(inlineSchemaReferences);
    if (value && typeof value === 'object') {
        const object = value;
        if (typeof object.$ref === 'string' && object.$ref.startsWith('#/')) {
            let target = requestSchemaDocument;
...
export const evidenceRequestJsonSchema = inlineSchemaReferences(requestSchemaDocument.properties.request);
